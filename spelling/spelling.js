...
var dict = fs.readFileSync("/usr/share/dict/american-english-small", "ascii");

console.log("Creating Speller object...");
var s = new Speller(dict);

console.log("Okay type a word.");

var stdin = process.openStdin();
stdin.on('data', function(chunk) {
	console.log("Correction: " + s.correct(String(chunk).slice(0, -1)));
});
